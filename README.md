...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/cyansilver/finance-go) [![Build Status](https://travis-ci.org/cyansilver/finance-go.svg?branch=master)](https://travis-ci.org/cyansilver/finance-go) [![Coverage Status](https://coveralls.io/repos/github/cyansilver/finance-go/badge.svg?branch=master)](https://coveralls.io/github/cyansilver/finance-go?branch=master)
...
A neatly formatted detailed list of implementation instructions and examples will be available on the [cyansilver website][api-docs].
...
```sh
go get github.com/cyansilver/finance-go
```
...
### Docker
```sh
  docker run -p 12111:12111 cyansilver/finance-mock:latest
```
### Brew

    brew tap cyansilver/finance-mock
    brew install finance-mock
    finance-mock

### Go

    go get -u github.com/cyansilver/finance-mock
    finance-mock
...
[godoc]: http://godoc.org/github.com/cyansilver/finance-go
[issues]: https://github.com/cyansilver/finance-go/issues/new
[qtrn]: https://github.com/cyansilver/qtrn
[pulls]: https://github.com/cyansilver/finance-go/pulls
[finance-mock]: https://github.com/cyansilver/finance-mock
[stripe]: https://github.com/stripe/stripe-go
[api-docs]: https://cyansilver.io/projects/finance-go/
